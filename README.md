...
Features
1.Top 10 Artists and Songs: Displays your most listened-to artists and tracks over the past year with images and rankings.

2.Top Genres: Shows your favorite genres extracted from your top artists.

3.Listening Metrics:
(i)Most active listening day
(ii)Longest listening time in a single day
(iii)Longest listening streak in days
(iv)Year with the most songs listened to
(v)Top listening era (e.g., 2010s, 2020s)
...
3.Snowflake: Stores the Spotify data in a secure cloud data warehouse.
...
2.Data Storage: Data is pushed into Snowflake for structured storage and easy querying.
